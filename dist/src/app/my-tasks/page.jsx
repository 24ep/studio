...
async function getInitialTaskBoardData(session) {
  ...
  `;
    ...
    // Await all promises
    const [positionsResult, stagesResult, recruitersQueryResult, candidatesQueryResult] = await Promise.allSettled([
        positionsPromise,
        stagesPromise,
        recruitersPromise,
        candidatesPromise
...
export default async function MyTasksPageServer() {
    ...
    return (<MyTasksPageClient initialCandidates={initialCandidates} initialPositions={initialPositions} initialStages={initialStages} initialRecruiters={initialRecruiters} initialFetchError={error}/>);
}
