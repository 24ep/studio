...
export default async function DashboardPageServer() {
    ...
    return (<DashboardPageClient initialCandidates={Array.isArray(initialCandidates) ? initialCandidates : []} initialPositions={Array.isArray(initialPositions) ? initialPositions : []} initialUsers={Array.isArray(initialUsers) ? initialUsers : []} initialFetchError={fetchError === null || fetchError === void 0 ? void 0 : fetchError.trim()}/>);
}
