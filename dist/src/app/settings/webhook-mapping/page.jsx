...
import { Save, SlidersHorizontal, Info, Loader2, ServerCrash, RefreshCw } from 'lucide-react';
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger, } from "@/components/ui/accordion";
import { toast } from 'react-hot-toast';
const TARGET_CANDIDATE_ATTRIBUTES_CONFIG = [
...
export default function WebhookMappingPage() {
    ...
    const initializeMappings = useCallback((dbMappings) => {
