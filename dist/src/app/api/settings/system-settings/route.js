...
export async function GET(request) {
    ...
    try {
        ...
        return NextResponse.json({ message: "Error fetching system settings", error: error.message }, { status: 500 });
    }
}
export async function POST(request) {
    ...
    if (!validationResult.success) {
        return NextResponse.json({ message: "Invalid input for system settings", errors: validationResult.error.flatten().fieldErrors }, { status: 400 });
    }
