...
export function CreateCandidateViaN8nModal({ isOpen, onOpenChange, onProcessingStart }) {
    ...
    useEffect(() => {
        if (isOpen) {
            ...
            const fileInput = document.getElementById('automated-candidate-pdf-upload');
            if (fileInput)
                fileInput.value = '';
        }
    }, [isOpen]);
      ...
      <DialogContent className="sm:max-w-lg">
        ...
        <div className="py-4 space-y-4">
            <div>
                ...
                <Input id="automated-candidate-pdf-upload" type="file" accept="application/pdf" onChange={handleFileChange} className="mt-1"/>
            </div>
            {selectedFile && (<div className="flex items-center justify-between p-2 bg-muted/50 rounded-md text-sm">
             ...
             <div>
              ...
              <Select value={selectedPositionId || NONE_POSITION_VALUE} onValueChange={(value) => setSelectedPositionId(value === NONE_POSITION_VALUE ? "" : value)}>
        ...
        <DialogFooter className="mt-2">
          ...
          <Button onClick={handleUploadForProcessing} disabled={!selectedFile || isUploading}>
