...
const AzureLogo = () => (<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="mr-2">
...
export function AzureAdSignInButton() {
    return (<Button onClick={() => signIn("azure-ad", { callbackUrl: "/" })} // Redirect to dashboard after sign-in
