...
export function Header({ pageTitle: initialPageTitle }) {
    ...
    if (!mounted || status === "loading") {
        return (<header className="flex h-16 items-center justify-between border-b bg-card px-4 md:px-6 sticky top-0 z-30">
      ...
      <header className="flex h-16 items-center justify-between border-b bg-card px-4 md:px-6 sticky top-0 z-30">
        ...
        <div className="flex items-center gap-3">
          ...
          {user ? (<DropdownMenu>
            ...
            </DropdownMenu>) : (<Button variant="outline" onClick={() => signIn()}>
