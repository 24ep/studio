                  ...
                  {activeTab === 'permissions' && !isSelfEdit && (<div className="space-y-8">
                          ...
                          <Popover open={groupSearchOpen} onOpenChange={setGroupSearchOpen}>
                            ...
                            <PopoverContent className="w-[--trigger-width] p-0 dropdown-content-height">
                              ...
                              <ScrollArea className="max-h-60">
                                ...
                                {filteredGroups.map(group => (<FormField key={group.id} control={form.control} name="groupIds" render={({ field }) => (<FormItem className="flex flex-row items-center space-x-3 space-y-0 px-3 py-2 hover:bg-accent rounded-sm">
                                        <FormControl>
                                          <Checkbox checked={field.value?.includes(group.id)} onCheckedChange={(checked) => checked
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="space-y-6 max-h-96 overflow-y-auto pr-2">
                          {groupedPermissions.map(group => (<div key={group.category} className="bg-muted/20 rounded-lg p-4 border">
                        ...
                        return (<FormItem className="flex flex-row items-center justify-between p-3 rounded-md bg-background hover:bg-muted/50 transition-colors border">
                                          ...
                                          <FormControl>
                                            <Toggle id={`${user?.id}-${module.id}`} checked={checked} onCheckedChange={(checked) => checked
