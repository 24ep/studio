...
# Dependencies are installed strictly from the committed package manifest,
# lockfile, and npm scope configuration. First-party @outborn packages resolve
# through registry.outborn.co exactly as they do in CI and local clean installs.
FROM base AS deps
