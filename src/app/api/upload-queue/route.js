...
export async function POST(request) {
    ...
    const client = await getPool().connect();
    try {
        const res = await client.query(`INSERT INTO upload_queue (id, file_name, file_size, status, source, upload_id, created_by)
       VALUES ($1, $2, $3, $4, $5, $6, $7)
       RETURNING *`, [id, file_name, file_size, status, source, upload_id, created_by]);
