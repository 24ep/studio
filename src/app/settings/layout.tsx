...
export const settingsNavItems: SettingsNavigationItem[] = [
  ...
  { href: "/settings/integrations", label: "System Settings", icon: Zap, description: "SMTP, webhooks, and processor concurrency.", permissionId: 'SYSTEM_SETTINGS_MANAGE' as PlatformModuleId, adminOnlyOrPermission: true },
