...
import { ArrowLeft, Briefcase, CalendarDays, Info, Loader2, ServerCrash, ShieldAlert, Users } from 'lucide-react';
...
export default function PositionDetailPage() {
    ...
    const refreshCandidateInList = async (candidateId) => {
        await fetchPositionAndCandidates();
    };
    const onToggleSelectCandidate = (candidateId) => {
    ...
    return (<div className="space-y-6 p-6">
      ...
      <Card className="shadow-lg">
        ...
        <CardContent className="space-y-4">
          {position.description && (<div className="text-sm text-muted-foreground">
